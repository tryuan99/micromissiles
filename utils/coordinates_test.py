...
class CartesianCoordinatesTestCase(absltest.TestCase):
    ...
    def test_transform_to_spherical(self):
        spherical_coordinates = self.cartesian_coordinates.transform_to_spherical(
        )
    ...
    def test_transform_to_spherical_identity(self):
        ...
        transformed_cartesian_coordinates = spherical_coordinates.transform_to_cartesian(
        )
...
class SphericalCoordinatesTestCase(absltest.TestCase):
    ...
    def test_transform_to_cartesian(self):
        cartesian_coordinates = self.spherical_coordinates.transform_to_cartesian(
        )
    ...
    def test_transform_to_cartesian_identity(self):
        ...
        transformed_spherical_coordinates = cartesian_coordinates.transform_to_spherical(
        )
