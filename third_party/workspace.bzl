...
load("//third_party/libmpc:workspace.bzl", "libmpc_workspace")
load("//third_party/nlopt:workspace.bzl", "nlopt_workspace")
...
load("//third_party/osqp:workspace.bzl", "osqp_workspace")
